  ...
  return (
    <div className="app">
      <header className="page-header">
        <h1>Bauhaus Design System — <span>Atoms &amp; Layout</span></h1>
        <p>Visual verification of all atom components against the <strong>01.jpeg</strong> reference.</p>
      </header>
      ...
      <section className="section">
        ...
        <p className="hint">
          Containers control size, proportion, layering &amp; position.
          Atoms remain pure — only the wrapper changes.
        </p>
        ...
        <div className="grid combos">
          ...
          <Cell label='<BauhausGrid layout="2x2" gap="2px" />'>
            <BauhausGrid layout="2x2" gap="2px" showBorder>
              <RatioBox ratio="1:1" bg="var(--color-red)"><Circle fill="var(--color-white)" /></RatioBox>
              <RatioBox ratio="1:1"><Checkerboard cols={3} rows={3} colorA="var(--color-black)" colorB="var(--color-white)" /></RatioBox>
              <RatioBox ratio="1:1" bg="var(--color-yellow)"><Triangle direction="up" fill="var(--color-black)" /></RatioBox>
              <RatioBox ratio="1:1" bg="var(--color-blue)"><HalfCircle orientation="bottom" fill="var(--color-white)" /></RatioBox>
            </BauhausGrid>
          </Cell>

          <Cell label='<BauhausGrid layout="3x3" gap="0" />'>
            <BauhausGrid layout="3x3" gap="0" showBorder>
              <RatioBox ratio="1:1"><Checkerboard cols={2} rows={2} colorA="var(--color-black)" colorB="var(--color-white)" /></RatioBox>
              <RatioBox ratio="1:1" bg="var(--color-blue)"><Circle fill="var(--color-yellow)" /></RatioBox>
              <RatioBox ratio="1:1" bg="var(--color-red)"><Triangle direction="right" fill="var(--color-white)" /></RatioBox>
              <RatioBox ratio="1:1" bg="var(--color-yellow)"><HalfCircle orientation="top" fill="var(--color-red)" /></RatioBox>
              <RatioBox ratio="1:1"><Sunburst rays={12} stroke="var(--color-black)" strokeWidth={1} /></RatioBox>
              <RatioBox ratio="1:1" bg="var(--color-blue)"><Rectangle fill="var(--color-white)" /></RatioBox>
              <RatioBox ratio="1:1" bg="var(--color-pink)"><Triangle direction="down" fill="var(--color-white)" /></RatioBox>
              <RatioBox ratio="1:1" bg="var(--color-black)"><Circle fill="var(--color-yellow)" /></RatioBox>
              <RatioBox ratio="1:1"><Checkerboard cols={2} rows={2} colorA="var(--color-blue)" colorB="var(--color-yellow)" /></RatioBox>
            </BauhausGrid>
          </Cell>
      ...
      <section className="section">
        ...
        <p className="hint">
          Assembled from Level 1 atoms + Level 2 containers. Each matches a
          specific illustration motif from the <strong>01.jpeg</strong> reference.
        </p>
        ...
        <div className="grid">
          ...
          <Cell label="<BauhausEye bg=red ringColor=white />">
            <BauhausEye bg="var(--color-red)" ringColor="var(--color-white)" pupilColor="var(--color-blue)" highlightColor="var(--color-yellow)" />
          </Cell>
        </div>

        {/* ── HeroGrid ─────────────────────────────────────── */}
        <h3 className="sub-heading">HeroGrid — 3×3 reference illustration</h3>
      ...
      <footer className="page-footer">
        <p>Bauhaus UI Lib — Level 0 ✓ &nbsp;|&nbsp; Level 1 Atoms ✓ &nbsp;|&nbsp; Level 2 Layout ✓ &nbsp;|&nbsp; Level 3 Composites ✓ &nbsp;🎉</p>
      </footer>
    </div>
  )
}
